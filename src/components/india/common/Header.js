      ...
      <nav className="container relative mx-auto">
        <div className="flex items-center justify-between h-20 px-6">
          ...
          <div className="items-center hidden space-x-8 md:flex">
            <Link href="/">
              <span className="text-gray-700 hover:text-primary transition-colors duration-200">
                Home
              </span>
            </Link>
            <Link href="/about">
            ...
            <Link href="/visa/step-one">
              <span className="inline-flex items-center px-6 py-2.5 text-sm font-medium text-white bg-primary rounded-full hover:bg-primary-dark transition-colors duration-200">
                Start Application
                <svg
          ...
          <nav className="divide-y divide-gray-100">
            ...
            <div className="p-4">
              <Link
                ...
                className="block w-full py-3 text-center text-white bg-primary hover:bg-primary-dark transition-colors duration-200 rounded-lg"
              >
                Start Application
              </Link>
            </div>
